...
public class FtcDecodeV1Autonomous extends LinearOpMode {
    ...
    private static final double AUTO_DRIVE_POWER = 0.5;
    ...
    public void runOpMode() {
        ...
        Command[] sequence = {
            new Command(CommandType.MOVE,   Direction.FORWARD, 1.0),
            new Command(CommandType.NOP,   Direction.FORWARD, 0.5),
            new Command(CommandType.SHOOT, Direction.FORWARD, 1.0),
            new Command(CommandType.MOVE,  Direction.BACKWARD, 1.0),
        };
